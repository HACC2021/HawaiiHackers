...
import ChallengeItemAdmin from '../components/ChallengeItemAdmin';
    ...
    return (
      <Container>
        ...
        <Table celled>
          ...
          <Table.Body>
            {this.props.challenges.map((challenge) => <ChallengeItemAdmin key={challenge._id} challenge={challenge} />)}
          </Table.Body>
        </Table>
      </Container>
    );
